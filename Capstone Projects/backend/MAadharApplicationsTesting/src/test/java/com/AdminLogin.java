...
public class AdminLogin {
	WebDriver driver; 
	public void launchBrowser() { System.setProperty("webdriver.chrome.driver", "C:\\Users\\uppal\\Downloads\\chrome-win64.zip\\chrome-win64.exe"); 
	...
	Thread.sleep(4000); driver.findElement(By.cssSelector(".btnsuccess")).click(); 
