...
public class SearchTest {
	...
	System.setProperty("webdriver.chrome.driver", "C:\\Users\\uppal\\Downloads\\chrome-win64.zip\\chrome-win64"); 
	...
	driver.findElements(By.xpath(".//span[@class='a-size-medium a-color-base a-text-normal']")); int size = resultsList.size(); 
	System.out.println("Size of list = " + size); 
	resultsList.get(2).click(); 
	System.out.println("The title of the page is :" + driver.getTitle()); }
	//Add to cart driver.findElement(By.cssSelector("#add-to-cartbutton")).click(); } 
	@Test 
