...
public class OperationController {
	...
	@DeleteMapping(value = "delete/{emailid}") public String 
	deleteUser(@PathVariable("emailid") String emailid){ return 
	ls.delete(emailid); 
	} 
